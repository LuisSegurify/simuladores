      ...
      evaluaciones: [
        {
          ...
          media: '/img/panel/market/cfc.png',
          videoTitulo: 'Soy video de Cálculos Financieros',
        ...
        {
          id: 2,
          name: 'Sistema Financiero Mexicano',
          percentage: 30,
          description:
            'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s,',
          media: '/img/panel/market/cfn.png',
          videoTitulo: 'Soy video de Sistema Financiero Mexicano y Conceptos',
          video: '/video/Video.mp4',
          infografia: '/img/panel/people/evaluaciones/infografia.png',
